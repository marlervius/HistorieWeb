  ...
  return <PageShell>
    <main className="page-main" id="main">
      ...
      <div className="chapter-layout">
        <aside className="chapter-rail" aria-label="På denne siden"><div className="rail-box"><h2>På denne siden</h2><ul><li><a href="#forkunnskap">Forkunnskap</a></li><li><a href="#mal">Mål og hovedspørsmål</a></li><li><a href="#tid-og-sted">Tid og sted</a></li><li><a href="#fakta">Fakta</a></li><li><a href="#forstaelse">Forståelse</a></li><li><a href="#kildeblikk">Kildeblikk</a></li><li><a href="#kildeverksted">Kildeverksted</a></li><li><a href="#lange-linjer">Lange linjer</a></li><li><a href="#oppgaver">Oppgaver</a></li><li><a href="#oppsummering">Oppsummering og egenvurdering</a></li><li><a href="#repetisjon">Repetisjon</a></li><li><a href="#kilder">Kilder</a></li></ul></div><div className="rail-box"><h2>Stabil lenke</h2><p className="local-note">Bruk lenken i OneNote eller ukeplanen.</p><CopyLinkButton /></div></aside>
        <article className="chapter-content">
          ...
          <section className="article-section" id="fagtekst"><div className="section-heading"><span className="eyebrow">Fagtekst</span><h2>Kjernefortelling</h2></div>{chapter.narrative.map((section) => <div key={section.heading}><h3>{section.heading}</h3>{section.paragraphs.map((paragraph) => <p key={paragraph}>{paragraph}</p>)}</div>)}</section>
          <section className="article-section" id="kildeverksted"><div className="section-heading"><span className="eyebrow">Kildeverksted</span><h2>Fra materielle spor til begrunnede slutninger</h2></div><p>Arbeid steg for steg: observer, sett kilden i sammenheng, vurder påstander, sammenstill spor og skriv en begrunnet konklusjon.</p>{chapter.sourceWorkshops.map((workshop) => <SourceWorkshop key={workshop.id} workshop={workshop} chapterId={chapter.id} />)}</section>
