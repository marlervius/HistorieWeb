  ...
  return <PageShell>
    <main className="page-main" id="main">
      ...
      <div className="chapter-layout">
        <aside className="chapter-rail" aria-label="På denne siden"><div className="rail-box"><h2>På denne siden</h2><ul><li><a href="#forkunnskap">Forkunnskap</a></li><li><a href="#mal">Mål og hovedspørsmål</a></li><li><a href="#tid-og-sted">Tid og sted</a></li><li><a href="#fakta">Fakta</a></li><li><a href="#forstaelse">Forståelse</a></li><li><a href="#kildeblikk">Kildeblikk</a></li><li><a href="#lange-linjer">Lange linjer</a></li><li><a href="#oppgaver">Oppgaver</a></li><li><a href="#oppsummering">Oppsummering og egenvurdering</a></li><li><a href="#repetisjon">Repetisjon</a></li><li><a href="#kilder">Kilder</a></li></ul></div><div className="rail-box"><h2>Stabil lenke</h2><p className="local-note">Bruk lenken i OneNote eller ukeplanen.</p><CopyLinkButton /></div></aside>
